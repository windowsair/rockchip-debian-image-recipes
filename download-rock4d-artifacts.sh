#!/bin/sh
#
# Downloads the latest artifacts from Collabora GitLab for the Radxa ROCK 4D
# image build
#
...
# Download u-boot artifacts for rock4d-rk3576
mkdir -p prebuilt/u-boot-rock4d-rk3576/
wget -O prebuilt/u-boot-rock4d-rk3576/u-boot.zip "https://gitlab.collabora.com/hardware-enablement/rockchip-3588/u-boot/-/jobs/artifacts/rockchip/download?job=build%20rock4d-rk3576:%20[upstream]"
unzip -j prebuilt/u-boot-rock4d-rk3576/u-boot.zip -d prebuilt/u-boot-rock4d-rk3576/
rm prebuilt/u-boot-rock4d-rk3576/u-boot.zip
